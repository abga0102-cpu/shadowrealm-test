/* Shadowreach v121 - Accomplissements retroactifs
   Compatibility-only state/event tracking for historical saves.
   Canonical UI and claims are owned by V139/V140. */
(function(){
  'use strict';
  ...
  /* Initialize/migrate accomplishment state once at module startup. The state is
     ...
     UI, claim, render, or polling ownership. */
  ...
  /* Familiar fusion history is still required by old saves/compatibility data.
     It does not own any Accomplishments presentation or payout behavior. */
