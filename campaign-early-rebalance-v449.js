/* SHADOWREACH V449 · Early Campaign rebalance authority
   ...
   - Facile 1-2 .. Facile 5-4  => HP -20%, damage +30%.
...
function multipliers(f){
  ...
  if(f>=FIRST&&f<=FIRST_END)return {hp:0.80,dmg:1.30,band:1};
...
window.__srCampaignEarlyRebalanceConfigV449={
  version:449,first:{from:2,to:84,visible:'Facile 1-2 → Facile 5-4',hpMul:.80,damageMul:1.30},
