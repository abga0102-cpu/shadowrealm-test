...
| Forge loot presentation / entry animation | `forge-ux-v273.js` | Current event-driven Forge loot authority. Owns the live loot zone, bounded/background-safe transient and kept-result lifecycle, comparison-aware AUTO feedback and idle watcher shutdown. Historical entry-animation V263/V264 and later UX predecessors V261/V266/V268–V272 are retired. |
...
- `forge-ux-v261.js`, `forge-ux-v266.js`, `forge-ux-v268.js`, `forge-ux-v269.js`, `forge-ux-v270.js`, `forge-ux-v271.js`, `forge-ux-v272.js` — superseded later Forge loot-presentation lineage retired from source; loaded `forge-ux-v273.js` is the current event-driven owner. V253/V258 remain separate compatibility-sensitive history pending their own audit.
