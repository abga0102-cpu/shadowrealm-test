...
| Forge loot presentation / entry animation | `forge-ux-v273.js` | Current event-driven Forge loot authority. Owns the live loot zone, transient/kept result animation and current presentation lifecycle; historical standalone entry-animation V263/V264 sources are retired. |
