...
| Accomplishments historical state / raid-win / familiar-fusion tracking | `accomplishments-v121.js` | Compatibility-only owner for historical save normalization and event counters. It must not own Accomplishments UI, Settings injection, reward definitions, or claim payouts. |
...
| Canonical Accomplishments claims | `accomplishments-claim-v140.js` | Future claim eligibility and payout authority. |
