/* SHADOWREACH V284 · Intrinsic skill progression
   Skills use their own fixed power, duplicate gauge and +10%/level growth.
...
function growth(level){return 1+Math.max(0,(Number(level)||1)-1)*.10;}
...
window.__srSkillOverhaulConfigV284={base:BASE,rarityBase:RAR,rates:A,levelGrowthPct:10,kameha:{targets:3,cooldown:10}};
})();