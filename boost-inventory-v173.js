/* SHADOWREACH · Boost inventory V173
   Temporary Sanctuary rewards are stored on claim and activated manually from
   the unified Personnage / Équipement screen. Active boosts remain visible on Home. */
(function(){
'use strict';
...
function activate(key){
 ...
 var a=clean(d.type);
 /* A boost already running is never consumed by a stray tap. The player chooses
    when to use the next item after the current one ends. */
...
function hookScreens(){
 ...
 if(typeof equip==='function'&&!equip.__boostV173){var e=function(){return equip()+panel();};e.__boostV173=true;SCREENS.equipement=e;SCREENS.personnage=e;SCREENS.inventaire=e;}
