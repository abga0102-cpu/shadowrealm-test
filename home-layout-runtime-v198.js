/* SHADOWREACH · Home layout runtime V198
   ...
   bottom-nav-runtime-v198.js. */
(function(){
  'use strict';
  if(window.__srHomeLayoutRuntimeV198)return;
  window.__srHomeLayoutRuntimeV198=true;

  var s=document.createElement('style');
  s.id='srHomeLayoutRuntimeV198';
  s.textContent=`
