...
test('V403 equipped skill level-up shows centered green Power feedback', async ({ page }) => {
...
test('V403 non-equipped skill level does not invent global Power feedback', async ({ page }) => {
  await page.goto('/index.html?smoke=1');
