...
test('V348 lowers Campaign pressure from 5-11 without going below 5-8', async ({ page }) => {
  ...
  expect(bossSource).toContain('campaignBalanceFloorV348');
  expect(easySource).toContain('var balanceFloor=campaignBalanceFloorV348(floor);');
