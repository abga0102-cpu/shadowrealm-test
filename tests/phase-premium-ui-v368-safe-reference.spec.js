...
test('V368 safe reference UI stays presentation-only and cache-busted', async () => {
  ...
  expect(ui).toContain('Premium UI polish V209 / V368');
  ...
  expect(index).toContain('shadowreach-build" content="2026.09.18.368"');
  expect(index).toContain("var V='2026.09.18.368'");
});
