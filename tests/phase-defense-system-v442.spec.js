...
test('V442 owns permanent Defense without adding a save field or a parallel runtime module', async ({}, testInfo) => {
...
test('V442 Defense is multiplicative after existing temporary reduction and displayed in Equipment UI', async ({ page }) => {
  await openCleanGame(page);
  const result = await page.evaluate(() => {
    const originalD = D;
