...
test('V420 keeps exact Global Gold caps and the V417 equipment rollback', async()=>{
  ...
  expect(legacy).toContain('globalGoldTierCapsPct:[5,10,15,20],globalGoldBranchMaxPct:50');
  ...
  expect(index).toContain('familiar-ladder-authority-v295.js?v=2026.09.22.420a');
