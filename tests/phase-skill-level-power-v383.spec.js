...
test('V383 gives +10% skill power per level and global Power reflects active skill levels', async ({ page }) => {
...
test('V383 shows duplicate progress when the level does not increase', async ({ page }) => {
  await page.goto('/index.html?smoke=1');
