...
test('V315 campaign is exactly 8 difficulties x 5 chapters x 10 stages with local 1-1 .. 5-10 notation', async ({ page }) => {
  ...
  expect(byFloor[1]).toMatchObject({ difficulty: 'Normal', chapter: 1, globalChapter: 1, difficultyChapter: 1, stage: 1, stageCode: '1-1' });
  expect(byFloor[10]).toMatchObject({ difficulty: 'Normal', chapter: 1, globalChapter: 1, difficultyChapter: 1, stage: 10, stageCode: '1-10', isBoss: true });
  expect(byFloor[11]).toMatchObject({ difficulty: 'Normal', chapter: 2, globalChapter: 2, difficultyChapter: 2, stage: 1, stageCode: '2-1' });
  expect(byFloor[50]).toMatchObject({ difficulty: 'Normal', chapter: 5, globalChapter: 5, difficultyChapter: 5, stage: 10, stageCode: '5-10', isBoss: true });
  expect(byFloor[51]).toMatchObject({ difficulty: 'Difficile', chapter: 1, globalChapter: 6, difficultyChapter: 1, stage: 1, stageCode: '1-1' });
  expect(byFloor[100]).toMatchObject({ difficulty: 'Difficile', chapter: 5, globalChapter: 10, difficultyChapter: 5, stage: 10, stageCode: '5-10', isBoss: true });
  expect(byFloor[101]).toMatchObject({ difficulty: 'Expert', chapter: 1, globalChapter: 11, difficultyChapter: 1, stage: 1, stageCode: '1-1' });
  expect(byFloor[150]).toMatchObject({ difficulty: 'Expert', chapter: 5, globalChapter: 15, difficultyChapter: 5, stage: 10, stageCode: '5-10', isBoss: true });
  expect(byFloor[151]).toMatchObject({ difficulty: 'Cauchemar', chapter: 1, globalChapter: 16, difficultyChapter: 1, stage: 1, stageCode: '1-1' });
  expect(byFloor[200]).toMatchObject({ difficulty: 'Cauchemar', chapter: 5, globalChapter: 20, difficultyChapter: 5, stage: 10, stageCode: '5-10', isBoss: true });
  expect(byFloor[201]).toMatchObject({ difficulty: 'Infernal', chapter: 1, globalChapter: 21, difficultyChapter: 1, stage: 1, stageCode: '1-1' });
  expect(byFloor[250]).toMatchObject({ difficulty: 'Infernal', chapter: 5, globalChapter: 25, difficultyChapter: 5, stage: 10, stageCode: '5-10', isBoss: true });
  expect(byFloor[251]).toMatchObject({ difficulty: 'Abyssal', chapter: 1, globalChapter: 26, difficultyChapter: 1, stage: 1, stageCode: '1-1' });
  expect(byFloor[300]).toMatchObject({ difficulty: 'Abyssal', chapter: 5, globalChapter: 30, difficultyChapter: 5, stage: 10, stageCode: '5-10', isBoss: true });
  expect(byFloor[301]).toMatchObject({ difficulty: 'Immortel', chapter: 1, globalChapter: 31, difficultyChapter: 1, stage: 1, stageCode: '1-1' });
  expect(byFloor[350]).toMatchObject({ difficulty: 'Immortel', chapter: 5, globalChapter: 35, difficultyChapter: 5, stage: 10, stageCode: '5-10', isBoss: true });
  expect(byFloor[351]).toMatchObject({ difficulty: 'Divin', chapter: 1, globalChapter: 36, difficultyChapter: 1, stage: 1, stageCode: '1-1' });
  expect(byFloor[400]).toMatchObject({ difficulty: 'Divin', chapter: 5, globalChapter: 40, difficultyChapter: 5, stage: 10, stageCode: '5-10', isBoss: true });
});
...
test('V314 final Divin boss uses the final boss HP authority, not extrapolated legacy scaling', async ({ page }) => {
  await openCleanGame(page);
...
test('V315 Home arena shows difficulty plus local chapter-stage notation', async ({ page }) => {
  await openCleanGame(page);
...
test('V315 final Boss completion cannot create an undefined stage and keeps Divin 5-10 replayable', async ({ page }) => {
  await openCleanGame(page);
