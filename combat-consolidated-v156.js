...
(function () {
  ...
  // Transition pacing: normal waves stay quick, floor/boss clears keep enough room
  // for the death effect and reward beat to remain readable.
  ...
  // One-shot boot hook: only the combat tick is sampled at ~60 Hz. Every other
  // game timer keeps its original cadence.
