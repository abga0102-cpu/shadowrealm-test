/* Shadowreach V231 — Familiar UI QA/stability. No save/economy changes. */
(function(){
  'use strict';
  if(window.__srFamQaV231)return;
  window.__srFamQaV231=true;
  ...
  function enhance(){
    ...
    try{
      ...
      var box=root.querySelector('#famAccelV231');
      ...
      if(!box){
        ...
        if(!shelf)return;
        box=document.createElement('details');box.id='famAccelV231';box.className='famDetails';
