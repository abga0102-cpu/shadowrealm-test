/* SHADOWREACH V288 · Boss final authority
   V351 extension: Campaign bosses from Facile 5-11 onward follow the same
...
(function(){
  ...
  function campaignBalanceFloorV351(floor){
  ...
  function bossHP(floor){
    floor=campaignBalanceFloorV351(floor);
  ...
  function legacyBossDamageStatMul(floor){
    ...
    var semantic=semanticLegacyFloor(campaignBalanceFloorV351(floor));
