/* SHADOWREACH V289 · Enemy balance authority
   ...
   V378 adds the requested global nerf on top of the live balance:
...
(function(){
  ...
  window.__srGlobalEnemyNerfV378=true;

  var LEGACY_MAX=400;
  var V362_CAMPAIGN_POWER_MUL=0.60;
  var GLOBAL_HP_MUL_V378=0.90;
  var GLOBAL_DAMAGE_MUL_V378=0.60;
  var CAMPAIGN_HP_MUL=V362_CAMPAIGN_POWER_MUL*GLOBAL_HP_MUL_V378;
  var CAMPAIGN_DAMAGE_MUL=V362_CAMPAIGN_POWER_MUL*GLOBAL_DAMAGE_MUL_V378;
  ...
  var RAID_HP_MUL=RAID_BASE_HP_MUL_V324*GLOBAL_HP_MUL_V378;
  var RAID_DAMAGE_MUL=RAID_BASE_DAMAGE_MUL_V324*GLOBAL_DAMAGE_MUL_V378;
  ...
  /* Keep the V324 Raid relationship, then apply the same V378 global nerf.
  ...
  window.__srEnemyDamageConfigV289={
    ...
    campaignHpMulV378:CAMPAIGN_HP_MUL,campaignDamageMulV378:CAMPAIGN_DAMAGE_MUL,
    globalEnemyNerfV378:{
      hpMul:GLOBAL_HP_MUL_V378,damageMul:GLOBAL_DAMAGE_MUL_V378,
