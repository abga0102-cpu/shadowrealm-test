...
function install(){if(typeof S==='undefined'||typeof ACT==='undefined'||typeof openModal!=='function')return;var baseOpen=openModal;openModal=function(content,title){if(norm(title).trim()==='accomplissements')content=html();return baseOpen(content,title);};ACT.accomplishments=function(){openModal(html(),'Accomplissements');};installTitleInteraction();}
