...
#app.srHomeFullArena .worldRebirth span,#app.srHomeFullArena .worldDefis span{font-size:9.5px!important;line-height:1!important;white-space:nowrap!important}
...
#srSocial .head{padding:8px 10px!important;min-height:43px!important}#srSocial .srTabs{margin:5px 8px 3px!important}#srSocial .srMessages{padding:6px 8px 60px!important}#srSocial .srMsg{padding:6px 8px!important;margin-bottom:4px!important;border-radius:8px!important}#srSocial .srText{font-size:12px!important;line-height:1.32!important}#srSocial .srMeta{font-size:9.5px!important}#srSocial .srCompose{padding:6px!important}#srSocial .srCompose input{padding:8px 9px!important;font-size:16px!important}#srSocial .srCompose button{padding:8px 10px!important;font-size:12px!important}
...
@media(max-width:370px){
 ...
 #app.srHomeFullArena .worldRebirth span,#app.srHomeFullArena .worldDefis span{font-size:9px!important}
